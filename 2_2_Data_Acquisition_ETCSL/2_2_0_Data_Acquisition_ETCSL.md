...
In a few cases a single word in [ETCSL](https://etcsl.orinst.ox.ac.uk/) is represented by a sequence of two words in [ePSD2](http://oracc.org/epsd2) style. This is represented as follows in the `JSON`:
