...
> Note that changes in the [epsd2/literary][] and [DCCLT][] data may change the numbers and the arrangement of the table. The minimum of 200 words may be on the high side. The Notebook uses a default minimum of 50, but this can be adjusted by the user.
...
This is not say that there are no such words or expressions. The lemma **zipatum\[cord\]n** is one such example. This word appears a few times in [Dumuzid's Dream](http://etcsl.orinst.ox.ac.uk/cgi-bin/etcsl.cgi?text=c.1.4.3&display=Crit&charenc=gcirc#) and in Enki and the Turtle (currently not in the corpus). More remarkable is the absence of **še[tear]n**, a word that only appears in the expressions **šeₓ(SIG₇)-šeₓ(SIG₇) ... ŋa₂-ŋa₂** which means to sob or to cry. This is a fairly common expression, perhaps an onomatopoetic representation of the sound of sobbing.
...
[^5]: 	Attinger, Pascal. (2019, March 1). Edubba'a A (5.1.1). Zenodo. https://doi.org/10.5281/zenodo.2599639
